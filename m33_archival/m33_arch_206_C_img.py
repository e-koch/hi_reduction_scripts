...
if do_cont_image:
  # Image the continuum, just to take a look.
    ...
    clean(vis=vis, imagename=out_root+'.continuum_mfs',
          ...
          mode='mfs', width=1, nchan=25, start=200, cell='3arcsec',
...
if do_image:
    ...
    clean(vis=vis, imagename=out_root+'.dirty', restfreq='1420.40575177MHz',
          mode='channel', width='1.288km/s', nchan=205, start='-339.104km/s',
          cell='3arcsec',
          imsize=[2048, 2048], weighting='briggs', robust=0.0, niter=0,
          pbcor=False, interpolation='linear', usescratch=True,
...
if do_clean:
    ...
    clean(vis=vis, imagename=out_root+'.clean', mask=None, field='M33*',
          restfreq='1420.40575177MHz', mode='velocity',
          width='1.288km/s', nchan=205, start='-339.104km/s', cell='3arcsec',
