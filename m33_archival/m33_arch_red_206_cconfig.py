...
raw_files = ["AT206_1", "AT206_2", "AT206_3",
             "AT206_4", "AT206_5", "AT206_6"]
...
if do_load:
    ...
    import_21cm(out_root="M33_orig",
                raw_files=raw_files)

    orig_vis = "M33_orig.ms"

    split(vis=orig_vis, outputvis="M33_spl_ph.ms",
          scan='4, 8, 11, 15, 18, 21, 25, 28, 32, 35, 38, 42', field='0')
